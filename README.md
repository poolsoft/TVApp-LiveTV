...
- "Kanal değişiminde siyah ekran göster" ayarı (Ayarlar > Kanallar > Oynatma) açıldığında kanal geçişinde eski kanalın donmuş görüntüsü gizlenir; infobar okunabilir kalır ve yeni kanal görüntüsü gelince yayın gösterilir.
